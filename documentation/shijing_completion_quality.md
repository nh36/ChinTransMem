...
| --- | --- | --- | --- |
| guofeng-tangfeng-002 | 山有樞 | 詩經·國風·唐風·002 | Checked part-1 hOCR pp.378-379. Two of the key plant names are still OCR-corrupt in the surviving text, so the poem cannot be normalized confidently from the current witness. |
...
| guofeng-qifeng-002 | 還 | 詩經·國風·齊風·002 | Checked part-1 hOCR pp.353-354. The second stanza truncates after “You met me in the way to”, leaving the poem incomplete in the current witness. |
...
| guofeng-qifeng-002 | 還 | needs_text_repair | do_not_export_until_repaired | Checked part-1 hOCR pp.353-354. The second stanza truncates after “You met me in the way to”, leaving the poem incomplete in the current witness. |
...
| guofeng-tangfeng-002 | 山有樞 | needs_text_repair | do_not_export_until_repaired | Checked part-1 hOCR pp.378-379. Two of the key plant names are still OCR-corrupt in the surviving text, so the poem cannot be normalized confidently from the current witness. |
