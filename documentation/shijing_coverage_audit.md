...
| units_with_verified_public_domain_english_source | 256 |
| units_with_at_least_one_exact_alignment | 256 |
| exact_alignment_count | 591 |

## Exceptions

- Missing from manifest: 0
- Present but metadata-only: 55
- Present without verified public-domain translation: 55
- Present with coarse or non-preferred exact alignment: 84
