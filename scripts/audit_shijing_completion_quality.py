...
from shijing_quality import (
    ...
    UNRESOLVED_WITNESS_REPORT_PATH,
...
def audit_shijing_completion_quality(
    *,
    ...
    return write_shijing_quality_outputs(
        ...
        unresolved_witness_output_path=unresolved_witness_output_path,
    )
...
def main() -> None:
    ...
    parser.add_argument("--unresolved-witness-output", type=Path, default=UNRESOLVED_WITNESS_REPORT_PATH)
    args = parser.parse_args()
    report = audit_shijing_completion_quality(
        json_output_path=args.json_output,
        markdown_output_path=args.markdown_output,
        spotcheck_output_path=args.spotcheck_output,
        unresolved_witness_output_path=args.unresolved_witness_output,
    )
